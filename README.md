...
- There are no any prompts or tips on the emerged issue with the source code correctness. Error message is the only
  sign of the ill-formed source code
- All the functions are to be in capitals with mandatory parentheses following (even for `HALT()`)
